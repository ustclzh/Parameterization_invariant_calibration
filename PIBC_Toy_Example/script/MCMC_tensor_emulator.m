function result=MCMC_tensor_emulator(data,para_MCMC,start_point,Sigma)
    global MCMC_scale
    ...
    logpost_current=log_posterior_emulator(data,D_current);
    ...
    for i=1:N
        ...
        logpost_new=log_posterior_emulator(data,D_new);
